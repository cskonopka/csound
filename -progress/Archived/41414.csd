...
;
;
;isample1   ftgen 2, 0, isize, 1, "ghettolife.wav", 0, 0, 0
;
;
;
;
;isample   ftgen 3, 0, ift, 1, "ghettolife.wav", 0, 0, 0
;
;print ift
...
kstartpoint scale kstartpoint, 132300, 0

kendpoint =  (kEnd + ((kshift/2)-(-(100/2))))
kendpoint scale kendpoint, 132300, 0
...
;elseif (kendp
	...
	ain 			lposcil3 	.8, kpitch, kstartpoint, kendpoint, 1
