...
; 	MaxMSP Controls
 	gkFM1freq		chnget 		"kFM1freq"  	
   	gkFM1car       	chnget 		"kFM1car"
   	gkFM1mod      	chnget 		"kFM1mod"
   	gkFM1dex      	chnget 		"kFM1dex"    
	gkOscFreq		chnget		"kOscFreq"
	gkOsc1Trig		chnget		"kOsc1Trig"	
	gkOsc2Trig		chnget		"kOsc2Trig"	
	gkOsc3Trig		chnget		"kOsc3Trig"	

;	Nebulae Controls
;	; ~ gkOsc1Trig ~ [Speed]
;	gkOsc1Trig 		ctrl14 			1, 1, 2, 0.1, 13	
;	gkOsc1Trig 		port 			gkOsc1Trig, 0.06
;
;	; ~ gkOsc2Trig ~ [Pitch]	
;	gkOsc2Trig 		ctrl14 			1, 15, 16, 0.1, 13
;	gkOsc2Trig 		port 			gkOsc2Trig, 0.06	
;
;	; ~ gkOsc3Trig ~ [Glide]	
;	gkOsc3Trig 		ctrl14 			1, 15, 16, 0.1, 13
;	gkOsc3Trig 		port 			gkOsc3Trig, 0.06	
;
;	; ~ gkOscFreq ~ [Mix]	
;					initc7 			1, 8, 1
;	gkOscFreq 		ctrl7 			1, 8, 0.1, 220
;	gkOscFreq 		port 			gkOscFreq, 0.06	
;
;	; ~ gkFM1freq ~ [Loop Start]	
;	gkFM1freq 		ctrl14 			1, 9, 10, 0.1, 120
;	gkFM1freq 		port 			gkFM1freq, 0.06		
;	
;	; ~ gkFM1car ~ [Loop Size]
;	gkFM1car 		ctrl14 			1, 11, 12, 0.1, 5
;	gkFM1car 		port 			gkFM1car, 0.06		
;
;	; ~ gkFM1mod ~ [Grain Size]
;	gkFM1mod 		ctrl7 			1, 4, 0.1, 5
;	gkFM1mod 		port 			gkFM1mod, 0.06		
;
;	; ~ gkFM1dex ~ [Grain Rate]
;	gkFM1dex 		ctrl7 			1, 5, 0.1, 5
;	gkFM1dex 		port 			gkFM1dex, 0.06		
;	
	...
	kTrig3			metro			gkOsc3Trig
		...
		if(kTrig1 == 1)then
			kLFO1			lfo 	.4, (gkOscFreq*0.55), 1			
			aNoise1			gauss	(2 * gkFM1dex)
			ares areson aNoise1, 1000, 100 
			aOsc1			oscili	.8, gkOscFreq*kLFO1, giGsine
		...
		if(kTrig2 == 1)then
			kLFO2			lfo 	.4, (gkOscFreq*0.89), 2			
			aNoise2			gauss	(4 * gkFM1dex)
			ares2 			areson 	aNoise2, 1600, 300 
			aOsc2			oscili	.8, (gkOscFreq*0.089)*kLFO2, giRecaman2
		...
		if(kTrig3 == 1)then
			kLFO3			lfo 	.4, (gkOscFreq*0.2), 5			
			aNoise3			gauss	(3* gkFM1dex)
			ares3 			areson 	aNoise3, 1800, 500 
			aOsc3			oscili	.8, (gkOscFreq*0.055)*kLFO3, giGsine
