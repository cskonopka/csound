...
; [Nebulae Controls]
	; ~ ENV Stretch ~ 		[Speed]
	kENVstretch 	ctrl14 	1, 1, 2, 0.001, 4
	...
	; ~ Resonance ~ 		[Glide]
	kResonance 		ctrl7 	1, 70, 0.001, 1	
	kResonance 		portk 	kResonance, 0.08

	; ~ CombReverb ~ 	[Mix]
				initc7 	1, 8, 1
	kVerbMix 		ctrl7 	1, 8, 0.1, 4
	kVerbMix 		portk 	kVerbMix, 0.08	

	; ~ Frequency ~ 		[Loop Start]
	kFrequency 		ctrl14 	1, 9, 10, 0.1, 880
	...
	kLowShift 		ctrl7 	1, 4, 0.1, 5
	kLowShift 		portk 	kLowShift, 0.08
		
		kosc oscil 1, kBnkOSCf2, giRecaman
		
		kosc1 oscil 1, kBnkOSCf1+13, giRecaman
		kosc2 oscil 1, kBnkOSCf2+47, giRecaman				
		kosc3 oscil 1, kBnkOSCf1+26, giRecaman
		kosc4 oscil 1, kBnkOSCf2+94, giRecaman
						
		aosc1 oscil 1, (kFrequency+120)*kosc1, gisine
		aosc2 oscil 1, (kFrequency+64)*kosc2-2, giRecaman5
		aosc3 oscil 1, (kFrequency+28)*kosc3-6, giRecaman4
		aosc4 oscil 1, (kFrequency)*kosc4-4, giRecaman3
...
fs 		pvswarp 	fsig, kENVstretch, 1, (4000+kosc)+kLowShift, 1, .3, 100
