...
;
;
;kstartpoint = (kStart + ((kshift/2)+(50/2)))
;
;kendpoint =  (kEnd + ((kshift/2)-(-(50/2))))
...
kstartpoint = (kStart + (kshift/2)-(100/2))+kblur

kendpoint =  (kEnd + (kshift/2)-(-(100/2)))-kblur
