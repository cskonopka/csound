...
; [Nebulae Controls]
	...
	; ~ ENV Stretch ~ 		[Speed]
	kENVstretch 	ctrl14 	1, 1, 2, 0.001, kend
	...
	; ~ CombReverb ~ 	[Mix]
;				initc7 	1, 8, 1
	kVerbMix 		ctrl7 	1, 8, 0.001, kstart
...
;				if(kENVstretch == kVerbMix) then
;				kENVstretch = kENVstretch+1
;				kVerbMix = kVerbMix-1
;	
;				endif
;				
...
kbetarand betarand kVerbMix, 1, 1,


	ain 			lposcil3 	.9, 1, (kENVstretch-kstart)-kbetarand, (kENVstretch+10)+kbetarand, 10
