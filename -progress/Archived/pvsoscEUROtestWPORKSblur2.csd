...
; [Nebulae Controls]
	; ~ ENV Stretch ~ 		[Speed]
	kENVstretch 	ctrl14 	1, 1, 2, 0.001, 1
	...
	kFrequency 		ctrl14 	1, 9, 10, 0.001, 880	
	...
	kLowShift 		ctrl7 	1, 4, 0.001, 10
	kLowShift 		portk 	kLowShift, 0.08
				
		kosc oscil .8, kBnkOSCf2, gisine
		
		kosc1 oscil .8, kBnkOSCf1, giRecaman
		kosc2 oscil .8, kBnkOSCf2, giRecaman				
		kosc3 oscil .8, kBnkOSCf1, giRecaman
		kosc4 oscil .8, kBnkOSCf2, giRecaman
						
		aosc1 oscil .8, (kFrequency+120)*kosc1, gisine
		aosc2 oscil .8, (kFrequency+64)*kosc2*2, giRecaman5
		aosc3 oscil .8, (kFrequency+28)*kosc3*6, giRecaman4
		aosc4 oscil .8, (kFrequency)*kosc4*4, giRecaman3
		aosc5 oscil .8, (kFrequency+33)*kosc1, gisine
		aosc6 oscil .8, (kFrequency+99)*kosc2, giRecaman5
		aosc7 oscil .8, (kFrequency+150)*kosc3, giRecaman4
		aosc8 oscil .8, (kFrequency+190)*kosc4, giRecaman3
...
fs 		pvswarp 	fsig, kENVstretch, 1, (4000+kosc)-(400*kLowShift), 1, .3, 100

fblur pvsblur fs, (kLowShift*0.1), 1

asig pvsynth    fblur                    ; resynthesise it
