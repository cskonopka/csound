...
; Nebulae Parameters
	...
	koscT1 		portk 	koscT1, kporttime	

	; Pitch
	koscT2 		ctrl14 	1, 15, 16, 0.1, 13
	kosc2 		portk 	koscT2, kporttime	
	...
	kosc3 		portk 	koscT3, kporttime

	; Mix
				initc7 	1, 8, 1
	koscfreq 	ctrl7 	1, 8, 0.1, 220
	koscfreq 	portk 	koscfreq, kporttime
	
	; Grain Rate
	kindex 		ctrl7 	1, 5, 0.1, 5

	kindex 		portk 	kindex, kporttime

	; Grain Size
	kmodulator 	ctrl7 	1, 4, 0.1, 5
	kmodulator 	portk 	kmodulator, kporttime	
	...
	kcarrier 	portk 	kcarrier, kporttime	
	...
	; Combine Grouped Oscillators & Triggered Noise Delays
	aOsc 	=	 		((aOscTrig1)+aOscTrig2+aOscTrig3)+aOscGroup

	; FM
	aFM 	foscili		.8, kfreq, kcarrier, kmodulator, kindex, giMersenneSine

			; Combine FM & Noise Oscillators
