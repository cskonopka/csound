...
;
	...
	;
	kfreq 		ctrl7 		1, 70, 13, 440
	kfreq 		port 		kfreq, 0.06	
	...
	;
	kgrainsz 		ctrl14 		1, 11, 12, 0.001, 5
	kgrainsz 		port 		kgrainsz, 0.06	

	; ~ gkMaxFreq ~
	;kminfreq [Speed]
	;	- Minimum allowed frequency of oscillation
	;
	kprate 		ctrl14 		1, 1, 2, 0.1, 3
	kprate 		port 		kprate, 0.06
	
	; ~ kdens ~
	;kminfreq [Pitch]
	;	- Maximum allowed frequency of oscillation
	;
	kstart 		ctrl14 		1, 15, 16, .001, 10
	kstart 		port 		kstart, 0.06	
	
	; ~ kfrpow ~
	;kampscl [Grain Rate]
	;	- multiplier for the distribution's delta value for amplitude
	;
	kend 		ctrl7 		1, 5, 0.001, 10
	kend 		port 		kend, 0.06		
...
;aOut lposcil 1, 1, kloop, kend, 1



;kenv linsegr 0, 1, 1, 6, 0
aOut syncloop 	.2, kfreq, kpitch, kgrainsz, kprate ,0, kend,  1, 2, 2
