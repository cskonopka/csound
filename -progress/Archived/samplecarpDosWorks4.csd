...
iend2 = ftlen(gifn)   
	...
	;
	gkAdPar 		ctrl14 			1, 9, 10, 0.1, iend
	...
	;
	gkDdPar 		ctrl14 			1, 11, 12, 0.1, iend
...
aOut lposcil .2, gkDurScl, gkDdPar, gkMinFreq, gifn
;aOut2 lposcil .6, gkAmpScl, gkAdPar, iend2, ifn2
aenv expsega 0.01, 0.1, 1, 0.1, 0.5, 0.5, 0.01
...
f 3 0 0 1 "one.wav" 0 0 0
f 4 0 0 1 "three.wav" 0 0 0
