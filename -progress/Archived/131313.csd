...
iend2 = ftlen(2)   
	...
	;
	gkMinFreq 		ctrl14 			1, 15, 16, 0.01, 2
...
kloopstart ctrl14 1, 9, 10, 0, (96769)-0.01
kloopsize ctrl14 1, 11, 12, 0.01, (96769)



aOut lposcil .6, gkMinFreq, gkDurScl, gkAmpScl, 1
;aOut2 lposcil .6, gkAmpScl, gkAdPar, iend2, 2
...
fs1,fsi2 	pvsifd 		aOut, 2048, 1024, 0		
...
fs11,fsi12 	pvsifd 		aOut, 2048, 1024, 0						
fst1     	partials 	fs11, fsi12, .01, 1, 3, 512				

; Partial Cross-synthesis
fcr  		trcross 	fst, fst1, gkMaxFreq, .8, 2	

; Re-synthesis
aout2 		tradsyn 	fcr, 1, 1, 500, 1	
