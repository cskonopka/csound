...
; [Nebulae Controls]
	; ~ ENV Stretch ~ 		[Speed]
	kENVstretch 	ctrl14 	1, 1, 2, 0.01, 4
	...
	;kLowShift 		portk 	kLowShift, 0.08
		...
		kosc oscil 1, kBnkOSCf2, 3
		
		kosc1 oscil 1, kBnkOSCf1, 3
		kosc2 oscil 1, kBnkOSCf2, 3				
		kosc3 oscil 1, kBnkOSCf1, 3
		kosc4 oscil 1, kBnkOSCf2, 3
						
		aosc1 oscil 1, (kFrequency+120)*kosc1, 8
		aosc2 oscil 1, (kFrequency+64)*kosc2-2, 5
		aosc3 oscil 1, (kFrequency+28)*kosc3-6, 4
		aosc4 oscil 1, (kFrequency)*kosc4-4, 3
		
		aosc = aosc1+aosc2+aosc3+aosc4
		
		aComb comb aosc, kVerbMix, .1 
...
fs 		pvswarp 	fsig, kENVstretch, 1, (4000+kosc)+kLowShift, 1, .3, 80
