...
;fftin		pvsanal	ain, 1024, 256, 1024, 1; fft-analysis of the audio-signal
		...
		kosc oscil 50, kindex, giRecaman
		
		kline linseg 0.1, .9, .6, 1.2, .1
		kosc2 oscil 50, kmodulator, giRecaman
		;kosc2 = kosc2*kline
...
fsig  pvsosc   1, koscT1, 2, 1024 ; generate wave spectral signal
;;fsig1 pvsarp fsig, kindex, kmodulator, kcarrier

;fsig     pvsanal aosc, ifftsize, ioverlap, iwinsize, iwinshape

;fs pvswarp fsig, koscT3, koscT2
fs pvswarp fsig, koscT3, 1, (koscfreq*kosc), 1, .3, 100
...
;asig pvsadsyn fs, 10, 1

asig pvsynth    fs                    ; resynthesise it

ares moogvcf2 asig, 3000, .3
