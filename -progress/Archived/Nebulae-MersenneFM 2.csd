...
instr 2
	...
	gkOsc1Trig 	ctrl14 1, 1, 2, 0.1, 13

	; ~ gkOsc2Trig ~ [Pitch]
	;	Controls the trigger rate of its associated if-statement
	gkOsc2Trig 	ctrl14 1, 15, 16, 0.1, 13

	; ~ gkOsc3Trig ~ [Glide]
	;	Controls the trigger rate of its associated if-statement
	gkOsc3Trig ctrl7 1, 70, 0.1, 13

	; ~ gkOscFreq ~ [Mix]
	;	Ocillator master frequency
			initc7 1, 8, 1
	gkOscFreq 	ctrl7 1, 8, 0.1, 220
	
	; ~ gkFM1dex ~ [Grain Rate]
	;	FM index
	gkFM1dex ctrl7 1, 5, 0.1, 5

	; ~ gkFM1mod ~ [Grain Size]
	;	FM modulator
	gkFM1mod ctrl7 1, 4, 0.1, 5

	; ~ gkFM1freq ~ [Loop Start]
	;	FM frequency
	gkFM1freq ctrl14 1, 9, 10, 0.1, 120
	...
	; Oscillator group
	aOsc5 		oscil 	.3, (gkOscFreq*0.089), giGsine
	aOsc4 		oscil 	.3, (gkOscFreq*0.055), giRecaman2
	aOsc3 		oscil 	.3, (gkOscFreq*0.034), giGsine
	aOsc2 		oscil 	.3, (gkOscFreq*0.021), giRecaman1
	aOsc1 		oscil 	.3, (gkOscFreq), giMersenneSine
	...
	if(kTrig2 == 1)then	
		...
		aOsc2			oscili	.4, gkOscFreq*0.089, gisine
	...
	if(kTrig3 == 1)then			
		...
		aOsc3			oscili	.4, gkOscFreq*0.055, giRecaman4
	...
	; Main FM out
	aFM 	foscili		.8, gkFM1freq, gkFM1car, gkFM1mod, gkFM1dex, giMersenneSine
