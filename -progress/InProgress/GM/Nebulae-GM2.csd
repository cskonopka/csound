...
;			aLFOo1			lfo 	kLFOamp, (kLFOfreq*0.55), 1			
			...
			aOsc1			oscili	.6, kOscFreq, giGsine
...
;			aLFOo2			lfo 	kLFOamp, (kLFOfreq*0.89), 2			
			...
			aOsc2			oscili	.6', kOscFreq*0.089, giRecaman2
...
;			aLFOo3			lfo 	kLFOamp, kLFOfreq, 5			
			...
			aOsc3			oscili	.6, kOscFreq*0.055, giGsine
...
;		aSH 		samphold aOsc, kTrig4
		...
		aFM 	foscili			.7, kFM1freq, kFM1car, kFM1mod, kFM1dex, giMersenneSine
