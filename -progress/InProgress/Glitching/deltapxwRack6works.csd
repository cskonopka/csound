...
adel    =  sin (2 *3.14159265 * adel) *kS1 + 0.131 
adel2a    =  sin (2 *3.14159265 * adel) *((kS1+(kResonance+.13)-kS3)) * (.021+(kResonance-kS2))
aenv1 linseg 0, .8, .3
averb1 combinv adel*adel2a,1.5,.1
        deltapxw a1*aenv1,averb1*aenv1, 32

adel2    oscil   .3, (kOf2), 1
adel2    =  sin (2 * 3.14159265  * adel2) * kS2 + 0.21
adel2b    =  sin (2 *3.14159265 * adel2) *((kS2+(kResonance+.7)-kS1)) * .(47+(kResonance-kS3)) 
aenv2 linseg 0, .8, .3
averb2 combinv adel2*adel2b, .47, .1
        deltapxw a1*aenv2,averb2*aenv2, 32


adel3    oscil   .3, (kOf3), 1
adel3    =  sin (2 * 3.14159265  * adel3) * kS3 + (0.5)
adel3b    =  sin (2 * 3.14159265  * adel3) *((kS3+(.47+kResonance))-kS2) * (.5+(kResonance-kS1))
aenv3 linseg 0, .8, .8
aenv3a linseg .8, .8, .1
adel3 clip adel3, 1, 0.6
averb3 combinv adel3*adel3b, 2,.1
        deltapxw (a1*aenv3),averb3*aenv3 , 32
