...
; [Nebulae Controls]
	...
	; ~ Cutoff ~ 			[Pitch]
	kS1 		ctrl14 	1, 15, 16, 0.001, 1
	kS1 		portk 	kS1, 0.08	

	; ~ Resonance ~ 		[Glide]
	kResonance 		ctrl7 		1, 70, 0.001, 4	
...
adel2a    =  sin (2 *3.14159265 * adel) *((kS1+.9)-kS3) + (.21+(kResonance+kS2))
aenv2 linseg 0, .8, .3
        deltapxw a1, adel+adel2a, 32

adel    oscil   .3, kOf2, 1
adel    =  sin (2 * 3.14159265  * adel) * kS2 + 0.21
adel2b    =  sin (2 *3.14159265 * adel) *((kS2+.7)-kS1) + .47 
aenv2 linseg 0, .8, .3
...
adel3b    =  sin (2 * 3.14159265  * adel) *((kS3+(.47+kResonance))-kS2) + (.5)
aenv3 linseg 0, .8, .8
aenv3a linseg .8, .8, .1
