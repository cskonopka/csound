...
; [Nebulae Controls]
	...
	; ~ CombReverb ~ 		[Mix]
				initc7 	1, 8, 1
	kMf 		ctrl7 		1, 8, 20, 347
	kMf 		portk 	kMf, 0.08	

	; ~ Frequency ~ 		[Loop Start]
	kOf2 		ctrl14 	1, 9, 10, 0, .2
...
averb1 combinv adel*adel2a,1.5,.1
        deltapxw a1*aenv1,averb1, 32

adel2    oscil   .4, (kOf2), 1
...
averb3 combinv  adel3*adel3b, 2.47, .1

        deltapxw (a1*aenv3),averb3, 32
